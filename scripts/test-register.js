...
async function tryRegister() {
    console.log('Attempting to register inovantix.help@gmail.com...');
    ...
    if (error) {
        ...
        console.log('Registration Success! User status:', data.user ? 'Created/Joined' : 'Check email confirmation');
        if (data.user) {
